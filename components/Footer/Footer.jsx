  ...
  return (
    ...
    <div className="footerUp">
        ...
        <div className="left">
            ...
            <h3>Acerca de nosotros Dani y Nahu</h3>
    ...
    <p style={{padding:"10px 100px 50px 100px", textAlign:"center"}}> Dirección General de Defensa y Protección al Consumidor - Consultas y/o denuncias
